...
import com.beiing.animationdemo.fragment.SlidingListFragmentLeft;
...
public class Test1Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private SlidingListFragmentRight mSecondFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSecondFragment = new SlidingListFragmentRight();
    }
...
//            Fragment secondFragment = new SlidingListFragmentRight();
            FragmentManager fm = getFragmentManager();
            FragmentTransaction fragmentTransaction = fm.beginTransaction();
            FragmentTransactionExtended fragmentTransactionExtended = new FragmentTransactionExtended(this, fragmentTransaction, mFirstFragment, mSecondFragment, R.id.fragment_place);
